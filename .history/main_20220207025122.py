...
# yolov4 bbox
    ...
    b_4=[i[:4] for item in bbox_v4 for i in item]
...
# yolov5 bbox
    ...
    b_5=[i[:4] for item in bbox_v5 for i in item]
...
# merged
    ...
    boxes_list= np.append(s_4, s_5, axis= 0) 
    scores_list=np.append(b_4, b_5, axis= 0) 
...
boxes, scores, labels = weighted_boxes_fusion([boxes_list], [scores_list], [labels_list],weights=None, method=None, iou_thr=None, thresh=None)
