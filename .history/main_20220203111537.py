...
@torch.no_grad()
def run(weights_v5=ROOT / 'yolov5/runs/train/exp9/weights/last.pt',  # model.pt path(s)
...
#     parser.add_argument('--weights_v5', nargs='+', type=str, default=ROOT / '/yolov5/runs/train/exp9/weights/last.pt', help='model path(s)')
