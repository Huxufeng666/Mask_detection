...
from yolov4.tool.torch_utils import do_detect, get_region_boxes,bbox_ious
import argparse
import os
...
# merged
    ...
    # bbox_merged = bbox_ious(torch.from_numpy(bbox_v4),torch.from_numpy(bbox_v5),x1y1x2y2=True)
    bbox_merged = torch.from_numpy(bbox_v4),torch.from_numpy(bbox_v5)
