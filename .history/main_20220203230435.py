...
# yolov4 bbox
    ...
    boxes =  plot_boxes_cv2(img, bbox[0], 'runs/22.jpg', None)
...
# merged
    ...
    if mul_v4 > mul_v5:
       bbox_merged_1 = mul_v5
    else:
        bbox_merged_1 = mul_v4
    bbox_merged = bbox_merged_1.append()

    # if len(bbox_v4) > len(bbox_v5):
    #     bbox_merged =  bbox_v5
    # else:
    #     bbox_merged = bbox_v4
...
h, w = img.shape[:2]
for _, x in enumerate(bbox_merged_1):
