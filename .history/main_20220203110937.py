...
@torch.no_grad()
def run(weights_v5=ROOT / './runs/train/exp8/weights/last.pt',  # model.pt path(s)
...
def parse_opt():
    ...
    parser.add_argument('--weights_v5', nargs='+', type=str, default=ROOT / '/home/user/Mask_detection/yolov5/runs/train/exp9/weights/last.pt', help='model path(s)')
