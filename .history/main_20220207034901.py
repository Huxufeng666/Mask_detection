...
boxes, scores, labels = weighted_boxes_fusion(boxes_list, scores_list.shape(len(scores_list),1), labels_list.shape(len(scores_list),1), weights=None, iou_thr=None)
