...
def run(weights_v5=ROOT / 'yolov5/runs/train/exp9/weights/best.pt',  # model.pt path(s)
        source=ROOT / 'image/17.jpg',  # file/dir/URL/glob, 0 for webcam
...
def parse_opt():
    ...
    parser.add_argument('--weights_v5', nargs='+', type=str, default=ROOT / 'yolov5/runs/train/exp8/weights/last.pt', help='model path(s)')
    parser.add_argument('--source', type=str, default=ROOT / 'image/17.jpg', help='file/dir/URL/glob, 0 for webcam')
