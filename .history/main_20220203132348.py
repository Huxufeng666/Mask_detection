...
@torch.no_grad()
def run(weights_v5=ROOT / 'runs/train/exp9/weights/best.pt',  # model.pt path(s)
        source=ROOT / '/home/user/Mask_detection/image/15.jpg',  # file/dir/URL/glob, 0 for webcam
        imgsz=(608, 608),  # inference size (height, width)
...
#     parser.add_argument('--weights_v5', nargs='+', type=str, default=ROOT / 'runs/train/exp8/weights/best.pt', help='model path(s)')
#     parser.add_argument('--source', type=str, default=ROOT / '/home/user/Mask_detection/image/15.jpg', help='file/dir/URL/glob, 0 for webcam')
